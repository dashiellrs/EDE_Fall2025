...
NTL.phys.data.TuesLake.1990thru1999 <- filter(NTL.phys.data, year4 >= 1990 & year4 <= 1999 & 
...
```{r mutating data}
#add column with temp in different units; use function
