...
#command: ts(data,starting point,frequency of observations)
...
# data must have only one variable!
# "periodic" pulls frequency from ts object
...
wind_data_clean <- 
  wind_data %>% 
  mutate( AWND.clean = zoo::na.approx(AWND) ) #na.approx() interpolates missing obs
...
# Use first() to call first observation
...
# SMK Method 1: SeasonalMannKenall()
