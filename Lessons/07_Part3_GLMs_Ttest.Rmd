...
Are Ozone levels below the threshold for "good" AQI index (0-50)? I.e., is the mean less than 50?
...
length(EPAair$Ozone) #8976 observations = lots --> mean is good representation
...
# Format as a GLM
# Reframe question: is year a predictor of ozone levels?
