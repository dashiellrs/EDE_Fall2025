...
webpage <- read_html('https://www.ncwater.org/WUDC/app/WWATR/report/view/0004-0001/2024')
webpage
```
...
df_withdrawals <- df_withdrawals %>% 
  mutate(Registrant = !!the_registrant, #!! = "use as variable, not string"
...
## 3.1 Get a list of facility IDs via scraping
...
dfs_2020 <- map2(the_years, the_facility_ids_subset, scrape.it) #input: two lists of same size, function
