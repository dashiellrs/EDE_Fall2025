...
NTL.phys.data.TuesLake.1990thru1999 <- filter(NTL.phys.data, lakename == "Tuesday Lake", year4 >= 1990 & year4 <= 1999)

```
Question: Why don't we filter using row numbers?

> Answer: We don't control the row numbers; they change all the time.
...
NTL.phys.data.TuesLake.1990thru1999.july <-
  NTL.phys.data %>%
  filter(
