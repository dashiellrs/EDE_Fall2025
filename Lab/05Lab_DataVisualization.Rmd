...
ggplot(data=data.frame(x=0,y=0))+
  ...
  geom_text(
    ...
    #this ^^^ doesn't work in updated ggplot2 -> new version below vvv
...
print(surface_temp_by_DOY_plot)
...
Neonics$Endpoint <- 
  reorder(Neonics$Endpoint, Neonics$Endpoint, FUN = length, decreasing = TRUE) 
