...
data_source <- paste0(   #paste0 and commas just letting us break lines
...
data_source <- paste0('https://services.arcgis.com/QVENGdaPbd4LUkLV/arcgis/',
                      'rest/services/survey123_3d7e213f47a94f1b829aa7cf54eab',
                      '095_results/FeatureServer/0/query?outFields=*&where=',
                      '1%3D1&f=geojson')
