...
#Summary statistics operations on vectors
max(vector1)
...
```{r Creating Matrices}
# Matrices ----
matrix1 <- matrix(1:20, nrow = 5,ncol = 4) # first:last, number of rows, number of columns
matrix1
#matrix1 has __ rows and __ columns

matrix2 <- matrix(1:20, nrow = 5, ncol = 4, byrow = TRUE) 
# "byrow = TRUE" to change from increasing down columns to across rows
matrix2
...
matrix1[4,  ] # whole 4th row

matrix1[ , 3] # whole 3rd column

matrix1[c(12, 14)] #

matrix1[c(12:14)] #

matrix1[2:4, 1:3] # 2nd thru 4th row, 1st thru 3rd column
